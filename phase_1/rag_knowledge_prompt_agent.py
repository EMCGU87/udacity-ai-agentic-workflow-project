# Import the RAGAugmentedPromptAgent class
import os
...
print(f"\nStep 2: Calculating embeddings for {len(chunks)} chunks...")
print("(This may take 1-2 seconds per chunk - making API calls to OpenAI)")
embbedings = RAG_knowledge_prompt_agent.calculate_embeddings()
print("✓ Embeddings calculated")

print("\nStep 3: Processing prompt...")
